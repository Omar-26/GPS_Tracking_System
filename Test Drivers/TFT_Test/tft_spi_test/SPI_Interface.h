...
#define SPI_ClkPolarityPhase_Mode_2 (2)   //clock not inverted sample on trailing edge
#define SPI_ClkPolarityPhase_Mode_3 (3)   //clock inverted sample on leading edge
#define SPI_ClkPolarityPhase_Mode_4 (4)   //clock not inverted sample on trailing edge
