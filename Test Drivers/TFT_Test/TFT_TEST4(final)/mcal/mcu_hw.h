...
typedef struct
{
    EN_PARTS_TagType EN0 ;
    EN_PARTS_TagType EN1 ;
    EN_PARTS_TagType EN2 ;
    EN_PARTS_TagType EN3 ;
    EN_PARTS_TagType EN4 ;
} NVIC_TagType;

typedef union
{
    EN_PARTS_TagType    EN_PARTS;
    uint32              EN_ALL;
}EN_TagType;

#define NVIC_EN_INT(N)                                ( (*((volatile uint32*)(0xE000E100+((uint8)(N/32))*4)))|=   (1<<(N%32)) )
#define NVIC_SET_INT_GROUP(N,GROUP_NUMBER)            ( (*((volatile uint32*)(0xE000E400+((uint8)(N/4))*4))) |=   (GROUP_NUMBER<<(5+8*(N%4)) ))
#define NVIC_SET_INT_SUBGROUP(N,SUB_GROUP_NUMBER)     ( (*((volatile uint32*)(0xE000E400+((uint8)(N/4))*4))) |=   (SUB_GROUP_NUMBER<<(5+8*(N%4)) ))

#define APINT_REG_KEY 0x05FA0000

#define APINT_REG      (*((volatile APINT_TagType*)0xE000ED0C))
...
typedef union
{
    APINT_PARTS_TagType    APINT_PARTS;
    uint32                 APINT_ALL;
}APINT_TagType;
...
#define PORTA_APB_BaseAddr     ((volatile PORT_RegType*)0x400043FC)
#define PORTB_APB_BaseAddr     ((volatile PORT_RegType*)0x400053FC)
#define PORTC_APB_BaseAddr     ((volatile PORT_RegType*)0x400063FC)
#define PORTD_APB_BaseAddr     ((volatile PORT_RegType*)0x400073FC)
#define PORTE_APB_BaseAddr     ((volatile PORT_RegType*)0x400243FC)
#define PORTF_APB_BaseAddr     ((volatile PORT_RegType*)0x400253FC)
...
#define GPIO_COMMIT_LOCK          0x4C4F434B
#define GPIO_AHB(PORT)            (*((volatile GPIO_REGTYPE*)(0x400583FC+0x1000*PORT)))
#define GPIO_APB(PORT)            (*((volatile GPIO_REGTYPE*)(0x400043FC+0x1000*PORT)))
...
/*offset of each gate register*/
#define Gate_Peripheral_WD                      0
#define Gate_Peripheral_TIMER                   1
#define Gate_Peripheral_GPIO                    2
#define Gate_Peripheral_DMA                     3
#define Gate_Peripheral_HIB                     5
#define Gate_Peripheral_UART                    6
#define Gate_Peripheral_SSI                     7
#define Gate_Peripheral_I2C                     8
#define Gate_Peripheral_USB                     10
#define Gate_Peripheral_CAN                     13
#define Gate_Peripheral_ADC                     14
#define Gate_Peripheral_ACMP                    15
#define Gate_Peripheral_PWM                     16
#define Gate_Peripheral_QEI                     17
#define Gate_Peripheral_EEPROM                  22
#define Gate_Peripheral_WTIMER                  23
#define NO_OF_GATES_FOR_PHERIPHERALS            16
#define SysCtr_Open_Clock_REG(UNIT,GATE_KEY_VALUE) ((*((volatile uint32*)(0x400FE600+UNIT*4)))=GATE_KEY_VALUE)
#define SysCtr_Set_Clock_Source(Clock_Source)      ((*((volatile uint32*)(0x400FE608+UNIT*4)))=Clock_Source)
...
#define RCC2            (*((volatile RCC2_TagType*)0x400FE070))
#define RCC2_ALL        (*((volatile uint32*)0x400FE070))
/*===========================================================*
 * UART REGISTERS                                            *
 *========================================================== */
...
#define SSI0_BASE_ADDR                      0x40008000
#define SSI1_BASE_ADDR                      0x40009000
#define SSI2_BASE_ADDR                      0x4000A000
#define SSI3_BASE_ADDR                      0x4000B000

#define SSICR0(SSI_BASE_ADDR)               GET_REG(SSI_BASE_ADDR, SSI_SSICR0_TAG, SSICR0_OFFSET)
#define SSICR1(SSI_BASE_ADDR)               GET_REG(SSI_BASE_ADDR, SSI_SSICR1_TAG, SSICR1_OFFSET)
#define SSIDR(SSI_BASE_ADDR)                GET_REG(SSI_BASE_ADDR, uint32, SSIDR_OFFSET)
#define SSISR(SSI_BASE_ADDR)                GET_REG(SSI_BASE_ADDR, SSI_SSISR_TAG, SSISR_OFFSET)
#define SSICPSR(SSI_BASE_ADDR)              GET_REG(SSI_BASE_ADDR, uint32, SSICPSR_OFFSET)
#define SSIIM(SSI_BASE_ADDR)                GET_REG(SSI_BASE_ADDR, SSI_SSIIM_TAG, SSIIM_OFFSET)
#define SSIRIS(SSI_BASE_ADDR)               GET_REG(SSI_BASE_ADDR, SSI_SSIRIS_TAG, SSIRIS_OFFSET)
#define SSIMIS(SSI_BASE_ADDR)               GET_REG(SSI_BASE_ADDR, SSI_SSIMIS_TAG, SSIMIS_OFFSET)
#define SSIICR(SSI_BASE_ADDR)               GET_REG(SSI_BASE_ADDR, SSI_SSIICR_TAG, SSIICR_OFFSET)
#define SSIDMACTL(SSI_BASE_ADDR)            GET_REG(SSI_BASE_ADDR, SSI_SSIDMACTL_TAG, SSIDMACTL_OFFSET)
#define SSICC(SSI_BASE_ADDR)                GET_REG(SSI_BASE_ADDR, uint32, SSICC_OFFSET)
